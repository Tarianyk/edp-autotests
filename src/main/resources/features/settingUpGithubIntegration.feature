...
#    And User clicks 'Add parameter' button
    ...
    Examples:
      ...
      | username | password | github          | master     | String Parameter | NAME          | TYPE           | BUILD_TOOL     | BRANCH         | GIT_SERVER_CR_NAME | GIT_SERVER_CR_VERSION | GIT_SERVER     | GIT_SSH_PORT   | GIT_USERNAME   | GIT_CREDENTIALS_ID | REPOSITORY_PATH | JIRA_INTEGRATION_ENABLED | Process Job DSLs |
