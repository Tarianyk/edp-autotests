Feature: Autotests provisioning with Default versioning type
  ...
  @AddAutotestsDefVers @AddAutotests @AddCodebase
  Scenario Outline: Add autotests using Clone Strategy (gitlab)
    ...
    Examples:
      ...
      | java8-clone-autotests-gitlab-def-vers  | Clone            | java8-gitlab        | gitlabRepositoryLogin | gitlabRepositoryPassword | Java         | java8           | Maven     | master     | master            | default        | username | password | test                | allure              |
      | java11-clone-autotests-gitlab-def-vers | Clone            | java11-maven-gitlab | gitlabRepositoryLogin | gitlabRepositoryPassword | Java         | java11          | Maven     | master     | master            | default        | username | password | test                | allure              |
  ...
  Scenario Outline: Add autotests using Clone Strategy (github)
    ...
    Examples:
      | applicationName                        | codebaseStrategy | repository          | repositoryLogin       | repositoryPassword       | codeLanguage | languageVersion | buildTool | branchName | defaultBranchName | versioningType | username | password | autotestDescription | testReportFramework |
      | java8-clone-autotests-github-def-vers  | Clone            | java8-mavem-github  | githubRepositoryLogin | githubRepositoryPassword | Java         | java8           | Maven     | master     | master            | default        | username | password | test                | allure              |
      | java11-clone-autotests-github-def-vers | Clone            | java11-mavem-github | githubRepositoryLogin | githubRepositoryPassword | Java         | java11          | Maven     | master     | master            | default        | username | password | test                | allure              |
  ...
  Scenario Outline: Create autotest using Import strategy (gitlab)
    ...
    And User deletes "<applicationName>" codebase by request
    Examples:
      | applicationName | codebaseStrategy | gitServer | relativePath        | codeLanguage | languageVersion | buildTool | branchName | defaultBranchName | autotestDescription | ciPipelineProvisioner | versioningType | username | password |
      | java8-maven     | Import           | git-epam  | java8-gitlab        | Java         | java8           | Maven     | master     | master            | test                | gitlab                | default        | username | password |
      | java11-maven    | Import           | git-epam  | java11-maven-gitlab | Java         | java8           | Maven     | master     | master            | test                | gitlab                | default        | username | password |
  ...
  Scenario Outline: Create autotest using Import strategy (github)
    ...
    Examples:
      | applicationName   | codebaseStrategy | gitServer | relativePath        | codeLanguage | languageVersion | buildTool | branchName | defaultBranchName | autotestDescription | ciPipelineProvisioner | versioningType | username | password |
      | java-maven-java8  | Import           | github    | java8-mavem-github  | Java         | java8           | Maven     | master     | master            | test                | github                | default        | username | password |
      | java-maven-java11 | Import           | github    | java11-mavem-github | Java         | java11          | Maven     | master     | master            | test                | github                | default        | username | password |
