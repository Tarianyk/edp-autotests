Feature: Smoke
  ...
  Scenario Outline: Create library using Create strategy
    ...
    Examples:
      ...
      | python-lib-create-def-vers        | Create           | Python       | python-3.8      | Python    | master     | master            | default        | username | password |
  ...
  Scenario Outline: Create library using Clone strategy (Gitlab)
    ...
    Examples:
      ...
      | java8-maven-lib-gitlab-clone-def-vers   | Clone            | java8-gitlab          | gitlabRepositoryLogin | gitlabRepositoryPassword | Java         | java8           | Maven     | master     | master            | default        | username | password |
      | java11-gradle-lib-gitlab-clone-def-vers | Clone            | java11-gitlab         | gitlabRepositoryLogin | gitlabRepositoryPassword | Java         | java11          | Gradle    | master     | master            | default        | username | password |
      | dotnet-3-1-lib-gitlab-clone-def-vers    | Clone            | dotnet31-gitlab       | gitlabRepositoryLogin | gitlabRepositoryPassword | DotNet       | dotnet-3.1      | dotnet    | master     | master            | default        | username | password |
      | python-3-8-lib-gitlab-clone-def-vers    | Clone            | python38-gitlab       | gitlabRepositoryLogin | gitlabRepositoryPassword | Python       | python-3.8      | Python    | master     | master            | default        | username | password |
      | javascript-lib-gitlab-clone-def-vers    | Clone            | javascript-gitlab     | gitlabRepositoryLogin | gitlabRepositoryPassword | JavaScript   | react           | NPM       | master     | master            | default        | username | password |
      | go-beego--lib-gitlab-clone-def-vers     | Clone            | go-beego-gitlab       | gitlabRepositoryLogin | gitlabRepositoryPassword | Go           | beego           | Go        | master     | master            | default        | username | password |
      | go-operator-sdk-gitlab-clone-def-vers   | Clone            | go-operatorsdk-gitlab | gitlabRepositoryLogin | gitlabRepositoryPassword | Go           | operator-sdk    | Go        | master     | master            | default        | username | password |
      | dotnet-2-1-clone-gitlab-def-vers        | Clone            | go-operatorsdk-gitlab | gitlabRepositoryLogin | gitlabRepositoryPassword | Go           | operator-sdk    | Go        | master     | master            | default        | username | password |
...
#    And User deletes "<applicationName>" codebase by request
    ...
    Examples:
      ...
      | dotnet-dotnet-dotnet-3-1   | Import           | git-epam  | dotnet31-gitlab       | DotNet       | dotnet-3.1      | dotnet    | master     | master            | gitlab                | default        | username | password |
      | python-python-python-3-8   | Import           | git-epam  | python38-gitlab       | Python       | Python-3.8      | Python    | master     | master            | gitlab                | default        | username | password |
      | edp-react-helloworld       | Import           | git-epam  | javascript-gitlab     | JavaScript   | react           | NPM       | master     | master            | gitlab                | default        | username | password |
      | go-go-beego                | Import           | git-epam  | go-beego-gitlab       | Go           | beego           | Go        | master     | master            | gitlab                | default        | username | password |
      | go-go-operator-sdk         | Import           | git-epam  | go-operatorsdk-gitlab | Go           | operator-sdk    | Go        | master     | master            | gitlab                | default        | username | password |
  ...
  Scenario Outline: Create library using Import strategy (github)
    ...
    Examples:
      | applicationName           | codebaseStrategy | gitServer | relativePath       | codeLanguage | languageVersion | buildTool | branchName | defaultBranchName | ciPipelineProvisioner | versioningType | username | password |
      | edp-springboot-helloworld | Import           | github    | java8-mavem-github | Java         | java8           | Maven     | master     | master            | github                | default        | username | password |
      | python-3-8                | Import           | github    | python38-github    | Python       | Python-3.8      | Python    | master     | master            | github                | default        | username | password |
      | edp-javascript-project    | Import           | github    | javascript-github  | JavaScript   | react           | NPM       | master     | master            | github                | default        | username | password |
