...
###    And User deletes "<applicationName>" codebase by request
  ...
  Scenario Outline: Create application using Clone strategy (Gitlab)
    ...
    Examples:
      ...
      | dotnet-2-1-clone-gitlab-def-vers      | Clone            | go-operatorsdk-gitlab | gitlabRepositoryLogin | gitlabRepositoryPassword | DotNet       | dotnet-2.1      | dotnet    | master     | master            | default        | username | password |
  ...
  Scenario Outline: Create multi-module application using Clone strategy (Gitlab)
    ...
    Examples:
      | applicationName                         | codebaseStrategy | repository    | repositoryLogin       | repositoryPassword       | codeLanguage | languageVersion | buildTool | branchName | defaultBranchName | versioningType | username | password |
      | java8-maven-mult-clone-gitlab-def-vers  | Clone            | java8-gitlab  | gitlabRepositoryLogin | gitlabRepositoryPassword | Java         | java8           | Maven     | master     | master            | default        | username | password |
      | java11-maven-mult-clone-gitlab-def-vers | Clone            | java11-gitlab | gitlabRepositoryLogin | gitlabRepositoryPassword | Java         | java11          | Maven     | master     | master            | default        | username | password |
  ...
  Scenario Outline: Create multi-module application using Clone strategy (Github)
    ...
    Examples:
      | applicationName                        | codebaseStrategy | repository         | repositoryLogin       | repositoryPassword       | codeLanguage | languageVersion | buildTool | branchName | defaultBranchName | versioningType | username | password |
      | java8-maven-mult-clone-github-def-vers | Clone            | java8-mavem-github | githubRepositoryLogin | githubRepositoryPassword | Java         | java8           | Maven     | master     | master            | default        | username | password |
