...
#    And User clicks 'Create' button
    ...
    Examples:
      ...
      | petclinic       | Clone            | petclinic-deploy | gitlabRepositoryLogin | gitlabRepositoryPassword | Java         | java8           | Maven     | master     | master            | default        | username | password | petclinic | /         | PostgreSQL   | postgres:9.6    | 1                | Gi           | aws-efs           |
...
#    And User clicks 'Services' section
  ...
  Scenario Outline: Deploy sit for petclinic
    ...
    Examples:
      ...
      | username | password | petclinic-pipe-cd-pipeline | latest             | sit             |
